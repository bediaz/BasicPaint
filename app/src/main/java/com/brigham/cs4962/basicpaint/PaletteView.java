...
public class PaletteView extends ViewGroup {
	...
	final private ArrayList<Integer> m_paletteColors;
	private int m_color;
	private OnColorChangedListener m_OnColorChangedListener = null;
	private OnAddNewColorListener m_OnAddNewColorListener = null;
	...
	public PaletteView(Context context) {
		...
		m_paletteColors = new ArrayList<>(Arrays.asList(
				Color.RED,
	...
	void initializeListeners(PaintView child) {
	...
	public interface OnAddNewColorListener {
		void onAddNewColor(int newColor);
	}
}
