...
public class PaintView extends View {
	...
	private OnSplotchTouchListener m_onSplotchTouchListener = null;
	private OnSplotchReleaseListener m_onSplotchReleaseListener = null;
...
//            }
	...
	public interface OnSplotchTouchListener {
		void onSplotchTouched(PaintView v);
	}
	
	public interface OnSplotchReleaseListener {
		void onSplotchReleased(PaintView v);
	}
}
